...
if (!nexacro.BluetoothLE) {
	nexacro.BluetoothLE = function (name, parent) {
		...
		trace("nexacro.BluetoothLE = function (name, parent)");
	...
	_pBluetoothLE.discoverServices = function (device_address) {
		var params = '""';
	...
	_pBluetoothLE._onscanresult = function (objData) {
		if (nexacro._OS == "Windows") {
			...
			trace("_pBluetoothLE._onscanresult : " + objDataParsed.devicename);
	...
	_pBluetoothLE._fire_onscanresult = function (objBluetoothLE, eBluetoothLEScanDeviceEventInfo) {
		if (this.onscanresult && this.onscanresult._has_handlers) {
			trace("_pBluetoothLE._fire_onscanresult : " + eBluetoothLEScanDeviceEventInfo.device_name);
	...
	_pBluetoothLE._fire_onerror = function (objBluetoothLE, BluetoothLEErrorEventInfo) {
		trace("_pBluetoothLE._fire_onerror ");

		if (this.onerror && this.onerror._has_handlers) {
			trace("_pBluetoothLE._fire_onerror _has_handlers");
