...
public class NexaBoardServiceImpl extends EgovAbstractServiceImpl implements 
	...
	@Override
	public void nexaInsert(Map<String, String> param) {
		nexaBoardMapper.nexaInsert(param);
	}

	@Override
	public List<InsaVO> nexaSelect(Map<String, String> param) {
		return nexaBoardMapper.nexaSelect(param);
	}

	@Override
	public List<InsaVO> nexaSabun(Map<String, String> param) {
		return nexaBoardMapper.nexaSabun(param) ;
	}

	@Override
	public void nexaUpdate(InsaVO insaVO) {
		nexaBoardMapper.nexaUpdate(insaVO);
		System.out.println("insaVO:" + insaVO);
	}

	@Override
	public void nexaDelete(Map<String, String> param) {
		nexaBoardMapper.nexaDelete(param);
	}

	@Override
	public List<InsaComVO> nexaCombo() {
		return nexaBoardMapper.nexaCombo();
	}
}
