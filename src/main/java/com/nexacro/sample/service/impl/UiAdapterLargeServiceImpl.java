...
import com.nexacro.sample.service.impl.ibatis.UiAdapterLargeDataDAO;
...
public class UiAdapterLargeServiceImpl extends EgovAbstractServiceImpl implements UiAdapterLargeDataService {

    @Resource(name = "largeDataDAO")
    private UiAdapterLargeDataDAO largeDataDAO;
